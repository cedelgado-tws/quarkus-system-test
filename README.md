...
You can then execute your native executable with: `./target/quarkus-system-test-1.0.0-SNAPSHOT-runner`
...
- Micrometer registry - JMX ([guide](https://quarkus.io/guides/micrometer)): View metrics data using JMX
